            ...
            <div className="modal-dialog modal-lg" >
                <div className="modal-content">
                    <div className="modal-header px-4">
                        <h5 className="mb-0">Create Document</h5>
                        ...
                        <form onSubmit={(e) => e.preventDefault()} >
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-3">
                                    <label htmlFor="documentName" className="form-label fw-medium" >Document Name</label>
                                    <input id="documentName" className={`form-control ${styles.inputBox}`} value={form.documentName} 
                                    onChange={handleChange}   placeholder="Enter document name" />
